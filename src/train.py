from star_gan.main import get_parser, main


def train_star_gan(dataset, name, image_size=176, image_channels=3, c_dim=5, batch_size=16, agent_file=None,
                   lambda_counter=1., counter_mode="advantage", agent_type="olson", ablate_agent=False):
    """
...
if __name__ == "__main__":
    ...
    train_star_gan("PacMan_FearGhost_cropped_5actions", "PacMan_FearGhost", image_size=160, image_channels=3, c_dim=6,
